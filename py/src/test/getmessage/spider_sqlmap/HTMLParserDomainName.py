...
class HTMLParserDomainName(HTMLParser):
...
#         print 'data: \n\t', self.webcontent, '\n\n---------------->>>>>>>'
        ...
        hpdn = HTMLParserDomainName(self.domain, self.protocol, self.encoding, self.source_url)
...
#     url = 'http://www.dhcc.com.cn/'
    ...
    global f_link
    f_link = codecs.open(d.domain + '.txt', 'a', d.encoding)
